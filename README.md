...
### 次にできること 
랜덤재생음악 버튼 , 검색기능 및 공유시 장르별 선택기능(철학쪽으론 맞진 않지만 고객의 편의성을 위한?) , 
나만의 음악엘범만들기 및 나만의 플레이리스트, 음악을 하는 사람을위한 나만의 포트폴리오를 만들어주는 가이드? 즉 나의 프로필을 공유할수있도록, 
라이브 공연 파트, 과거에 청취했던 음악, 
